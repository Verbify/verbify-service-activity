...
import verbify_service_activity as activity
from verbify_service_activity.counter import ActivityCounter
from verbify_service_activity.activity_thrift import ActivityService
...
class ActivityServiceTests(unittest.TestCase):
    ...
    @mock.patch("verbify_service_activity.ActivityInfo", autospec=True)
    ...
    @mock.patch("verbify_service_activity.ActivityInfo", new=MockActivityInfo)
