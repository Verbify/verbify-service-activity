...
from verbify_service_activity.activity_thrift.ActivityService import Client
from verbify_service_activitygateway import ActivityGateway, make_wsgi_app
...
class GatewayFunctionalTests(unittest.TestCase):
    @mock.patch("verbify_service_activitygateway.ThriftConnectionPool")
    @mock.patch("verbify_service_activitygateway.make_metrics_client")
